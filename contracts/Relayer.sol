...
contract Relayer is Ownable {
    ...
    bytes32 internal constant implementationSlot = 0xbee7bf51329826bfc0e563da7798126a6e01520a976116af19816df6a763ed3f;
    ...
    function _getImplementationAddress() internal pure returns(Address storage r){
        assembly {
    ...
    fallback(bytes calldata data) external payable returns (bytes memory) {
        (bool success, bytes memory returnData) = getImplementationAddress().delegatecall(data);
        require(success);
        return returnData;
    }
}